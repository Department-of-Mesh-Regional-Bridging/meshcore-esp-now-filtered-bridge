  ...
  <p align="center"><strong>An Organization Dedicated to Producing Tools to Promote Healthy, Federated, and Intelligently-Scalable MeshCore Networks</strong></p>
      ...
      <p align="center"><strong> Acknowledgement: Extended from [@jbrazio's RS232/ESP-NOW Bridge/cross repeater](https://github.com/meshcore-dev/MeshCore/pull/454)</strong></p>
  <p align="center">
  </p>
</p>
   </td>
