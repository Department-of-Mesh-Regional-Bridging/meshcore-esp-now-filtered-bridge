...
private:
  ...
  protected:
    void structure() override {
      ...
      def("filter", (void*)&_parent->bridge_filter_policy, sizeof(_parent->bridge_filter_policy));
      // def("filter_policy", _parent->bridge_filter_policy.policy);
      // def("filter_first", (void*)_parent->bridge_filter_policy.blockedFirstBytes, sizeof(_parent->bridge_filter_policy.blockedFirstBytes));
      // def("filter_first_cnt", _parent->bridge_filter_policy.blockedFirstBytesCount);
      // def("filter_htags", _parent->bridge_filter_policy.blockedHTags, sizeof(_parent->bridge_filter_policy.blockedHTags));
      // def("filter_psks", (void*)_parent->bridge_filter_policy.blockedPSKs, sizeof(_parent->bridge_filter_policy.blockedPSKs));
      // def("filter_htag_cnt", _parent->bridge_filter_policy.blockedHTagCount);
    }
  public:
